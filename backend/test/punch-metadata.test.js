...
assert.deepStrictEqual(
  normalizeLocation({location_status:'captured',latitude:33.77,longitude:-81.93,accuracy_meters:8.5}),
  {location_status:'captured',latitude:33.77,longitude:-81.93,accuracy_meters:8.5},
);
assert.deepStrictEqual(
  normalizeLocation({location_status:'captured',latitude:999,longitude:-81.93,accuracy_meters:8.5}),
  {location_status:'error',latitude:null,longitude:null,accuracy_meters:null},
);
assert.deepStrictEqual(
  normalizeLocation({location_status:'denied'}),
  {location_status:'denied',latitude:null,longitude:null,accuracy_meters:null},
);
