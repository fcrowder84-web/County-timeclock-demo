...
assert.deepStrictEqual(effective,['access']);
const explicit=effectiveEmployeePermissions(['access','view_own_time','request_punch_correction']);
assert.deepStrictEqual(explicit,['access','view_own_time','request_punch_correction']);
